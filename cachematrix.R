...
## The following function returns the inverse of the matrix 'makeCacheMatrix'. 
## It first checks if the inverse has already been computed. 
## If so, it gets the result, printing "getting cached data" and skips the computation.
